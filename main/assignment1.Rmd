...
save(likelihood,file="output\\assignment1\\likelihood_A1.RData")
```
...
library(ggplot2)
library(latex2exp)
ggplot2::ggplot(likelihood,aes(beta_search,likelihood))+
  geom_point()+
  coord_cartesian()+
  labs(x= latex2exp::TeX("$\\beta$"), y= "Loglikelihood")
ggsave("figuretable\\assignment1\\loglike.png")
```
